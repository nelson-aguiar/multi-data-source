...
@Configuration
@EnableJpaRepositories(basePackages = "com.gft.repository.two", entityManagerFactoryRef = "userTwoEntityManager", transactionManagerRef = "userTwoTransactionManager")
...
public class DataBaseTwoConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerDBTwo(EntityManagerFactoryBuilder emf) {
		LocalContainerEntityManagerFactoryBean lcem = emf.dataSource(dataSourceTwo()).packages("com.gft.bean").build();
