...
@Configuration
@EnableJpaRepositories(basePackages = "com.gft.repository.one", entityManagerFactoryRef="userEntityManager", transactionManagerRef="userTransactionManager")
...
public class DataBaseOneConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerDBOne(EntityManagerFactoryBuilder emf) {
		LocalContainerEntityManagerFactoryBean lcem = emf.dataSource(dataSourceOne()).packages("com.gft.bean").build();
